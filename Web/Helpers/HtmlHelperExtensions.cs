    ...
    public static class HtmlHelperExtensions
    {
            ...
            where TModel : class
        {
            ...
            foreach (var item in items)
            {
                ...
                {
                    htmlBuilder.Append(_EditorForManyIndexField<TValue>(htmlFieldNameWithPrefix, guid,
        ...
        public static MvcHtmlString EditorForManyIndexField<TModel>(this HtmlHelper<TModel> html,
        ...
        private static MvcHtmlString _EditorForManyIndexField<TModel>(string htmlFieldNameWithPrefix, string guid,
